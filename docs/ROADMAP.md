...
- 2026-09-15: ChatGPT Standard browser implementation updated to Bridge Wake 2.1.0 (CSRF grant, update persistence, explicit default web selection, clearer account/offline UI). Offline fixtures/typecheck/build pass. Live E2E remains pending actual Chrome/Edge extension activation; zero provider requests in this change.
